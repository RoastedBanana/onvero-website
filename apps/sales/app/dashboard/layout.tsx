...
function buildNav(
  ...
  return [
    {
      title: 'ÜBERSICHT',
      items: [{ label: 'Home', href: '/dashboard', icon: ICONS.home }],
    },
    {
      title: 'PROSPECTS',
      items: [
        // { label: 'Market Intent', href: '/dashboard/prospects', icon: ICONS.zap, badge: `${mitEmail}` },
        { label: 'Lead Generator', href: '/dashboard/generate', icon: ICONS.spark },
        // { label: 'Outreach-Ideen', href: '/dashboard/outreach', icon: ICONS.mail },
        // { label: 'Monitoring', href: '/dashboard/monitoring', icon: ICONS.eye },
        { label: 'Network', href: '/dashboard/network', icon: ICONS.network, comingSoon: true },
      ],
    },
    {
      title: 'LEADS & KUNDEN',
      items: [
        {
          ...
          badge: `${leadCount}`,
          children: [
            { label: `Neu heute (${neuHeute})`, href: '/dashboard/unternehmen?filter=neu-heute' },
            { label: `Qualifiziert (${qualifiziert})`, href: '/dashboard/unternehmen?filter=qualifiziert' },
            { label: `In Kontakt (${inKontakt})`, href: '/dashboard/unternehmen?filter=kontakt' },
          ],
        },
        { label: 'People', href: '/dashboard/people', icon: ICONS.users },
        { label: 'Kunden', href: '/dashboard/kunden', icon: ICONS.check, comingSoon: true },
      ],
    },
    {
      title: 'PRODUKT',
      items: [
        { label: 'Meetings', href: '/dashboard/meetings', icon: ICONS.calendar },
        { label: 'Analytics', href: '/dashboard/analytics', icon: ICONS.chart },
      ],
    },
  ];
}
