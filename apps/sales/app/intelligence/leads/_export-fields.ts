...
export const EXPORT_FIELD_GROUPS: ExportFieldGroup[] = [
  ...
  },
  {
    ...
    fields: [
      { key: 'web_company_pitch', label: 'Firmen-Pitch' },
      { key: 'web_value_proposition', label: 'Value Proposition' },
      { key: 'web_core_services', label: 'Kern-Services' },
      ...
      { key: 'web_languages', label: 'Sprachen' },
      { key: 'web_page_count', label: 'Seitenanzahl' },
      ...
      { key: 'website_highlights', label: 'Website-Highlights' },
  ...
  },
  {
    ...
    label: 'Technologie',
    fields: [
      { key: 'web_tech_stack', label: 'Tech-Stack (Web)' },
