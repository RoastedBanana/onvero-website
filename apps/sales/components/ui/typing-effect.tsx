...
export const TypingEffect = ({
  ...
  return (
    <div
      ref={containerRef}
      style={style}
      className={cn('relative inline-flex items-center justify-center text-center text-4xl font-bold', className)}
    >
      {displayedText}
      <motion.span
        initial={{ opacity: 0 }}
        ...
        className={cn('ml-1 h-[1em] w-0.5 rounded-sm bg-current')}
      />
    </div>
  );
};
